...
const Navbar = () => {
  ...
  return (
    <div className="relative">
      <div className="backdrop-blur-[150px] transition-colors duration-800">
        <div className="dark:text-white shadow-[0px_4px_2px_-3px_#ddd] dark:shadow-none">
          <div className="md:flex justify-between items-center rounded-md w-[93%] md:w-[90%] mx-auto py-2 md:py-0 overflow-hidden">
            ...
            <div
              className={`absolute top-10 z-[1000] md:static md:flex justify-end h-screen md:h-auto mt-3 md:mt-0 ml-auto md:ml-0 shadow-xl bg-slate-100 dark:bg-gray-900 md:bg-transparent md:dark:bg-transparent md:shadow-none uppercase font-semibold transition-all duration-700 ease-out ${
